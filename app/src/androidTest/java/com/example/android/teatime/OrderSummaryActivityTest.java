...
// TODO DONE(1) Add annotation to specify AndroidJUnitRunner class as the default test runner
...
public class OrderSummaryActivityTest {
    ...
    // TODO DONE(2) Add the rule that indicates we want to use Espresso-Intents APIs in functional UI tests
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mActivityRule = new IntentsTestRule<>(
            OrderSummaryActivity.class);


    // TODO DONE(3) Finish this method which runs before each test and will stub all external
    ...
    // TODO DONE(4) Finish this method which verifies that the intent sent by clicking the send email
